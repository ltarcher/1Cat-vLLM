...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("grouped_verify_kv_heads_abi_version",
        &flash_attention_grouped_verify_kv_heads_abi_version,
        "Maximum per-rank KV-head count of grouped DFlash2 verification");
